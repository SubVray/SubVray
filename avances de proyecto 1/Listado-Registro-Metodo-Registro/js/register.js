const btnFormLogin = document.querySelector("#btn-login");
const btnFormRegister = document.querySelector("#btn-register");
...
anchoPage();
btnFormRegister.addEventListener("click", register);
btnFormLogin.addEventListener("click", login);
